...
<%
	//System.out.println("mypage.jsp ====="+ session);
	MemberDTO dto= (MemberDTO)session.getAttribute("login");
	//System.out.println("mypage.jsp ====="+ dto);
	String userid= dto.getUserid(); //hidden주의 
...
*아이디: <%= userid %><br>
<input type="hidden" name="userid" value="<%= userid %>"><!-- 주의  -->
...
전화번호:<select name="phone1">
  ...
  <option value="011" <% if ("011".equals(phone2)) {%> selected <% }%>> 011</option>
  <option value="010"  <%if ("011".equals(phone3)){ %> selected <%} %>> 011 </option>
